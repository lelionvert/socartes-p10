...
public class RegistrationPriceCalculatorTest {
    ...
    @Test
    public void acceptance_test_double_room_with_full_stay() {
    ...
    @Test
    public void acceptance_test_triple_room_with_full_stay() {
    ...
    @Test
    public void acceptance_test_no_accommodation_with_full_stay() {
